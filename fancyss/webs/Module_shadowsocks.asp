...
function conf2obj(obj, action) {
    ...
    if(obj["ss_basic_enable"] == "1"){
        $("#clash_dashboard").html("<iframe id='clash-dashboard' style='width:100%;min-height:45rem;border:0;margin-top:1px;' src='" + "http://" + location.hostname + ":9091/ui/#/setup?hostname=" + location.hostname + "&port=9091&secret=" + "'></iframe>");
        $("#show_btn5").show();
        $("#ss_switchnode_btn").show();
        $("#ss_switchnode_btn").prop("href", "http://" + location.hostname + ":9091/ui/#/setup?hostname=" + location.hostname + "&port=9091&secret=")
    }
}
...
function save() {
    ...
    // "ss_basic_udp_on", 
    // "ss_basic_tjai", 
    "ss_basic_nonetcheck", "ss_basic_notimecheck", "ss_basic_nochnipcheck", "ss_basic_nofrnipcheck", "ss_basic_noruncheck", "ss_basic_nofdnscheck", "ss_basic_nocdnscheck", "ss_basic_olddns", "ss_basic_advdns", "ss_basic_chnroute_update", "ss_basic_cdn_update", "ss_basic_kcp_nocomp", "ss_basic_udp_boost_enable", "ss_basic_udpv1_disable_filter", "ss_basic_udpv2_disableobscure", "ss_basic_udpv2_disablechecksum", "ss_basic_udp2raw_boost_enable", "ss_basic_udp2raw_a", "ss_basic_udp2raw_keeprule", "ss_basic_dns_hijack", "ss_basic_chng_no_ipv6", "ss_basic_chng_act", "ss_basic_chng_gt", "ss_basic_chng_mc", 
    // "ss_basic_mcore", 
    "ss_basic_chng_china_1_enable", "ss_basic_chng_china_2_enable", "ss_basic_chng_china_1_ecs", "ss_basic_chng_trust_1_enable", "ss_basic_chng_trust_2_enable", "ss_basic_chng_china_2_ecs", "ss_basic_chng_trust_1_ecs", "ss_basic_chng_trust_2_ecs", "ss_basic_proxy_newb", "ss_basic_udpoff", "ss_basic_udpall", "ss_basic_udpgpt"];
...
function verifyFields(r) {
    ...
    // hide ss_online_links
    $("#ss_online_links").on("focus", function() {
        $(this).attr("type", "text");
    }).on("blur", function() {
...
function refresh_html() {
    ...
    //for (var field in confs) {
        ...
        switch(c["type"]) {
            case '0' :
                if(E("ss_basic_score").checked){ //fancyss-full
                    // xray run ss
...
function get_config() {
    $.ajax({
        url: '/_temp/fancyss_config.txt',
        type: 'GET',
        cache:false,
        dataType: 'text',
        success: function(res) {
            $('#config_content1').val(res);
        }
    });
}
                                    ...
                                    <tr>
                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                            ...
                                            <div class="SimpleNote" id="head_illustrate">
                                                <ul id="fixed_msg" style="padding:0;margin:0;line-height:1.8;">
                                                    <li id="msg_0" style="list-style: none;height:23px">
                                                        📌 本插件使用 <a href="https://github.com/MetaCubeX/mihomo" target="_blank"><em><u>clash</u></em></a> 实现科学上网。
                                            ...
                                            <div id="ss_switch_show" style="margin:-1px 0px 0px 0px;">
                                                <table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="ss_switch_table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <div style="display: flex; border-width: inherit;">
                                                                ...
                                                                <div id="update_button" style="padding: 5.5px 0px;">
                                                                    <a id="updateBtn" type="button" class="ss_btn" style="cursor:pointer" onclick="update_ss()">检查并更新</a>
                                                                </div>
                                                                <div id="ss_version_show" style="margin-left: 10px;padding: 5.5px 0px;">
                                                                    <a><i>当前版本：</i></a>
                                                                </div>
                                                                <div style="margin-left: 10px;padding: 5.5px 0px;">
                                                    ...
                                                    <tr id="ss_state">
                                                        ...
                                                        <td>
                                                            <div style="display: flex;">
                                                                ...
                                                                <div style="margin-left: 20px;padding: 10.5px 0px;">
                                                                    <a id="ss_switchnode_btn" type="button" class="ss_btn" style="cursor:pointer;display:none;" target="_blank" href="javascript:void(0);">线路面板</a>
                                                                </div>
                                                                <div style="margin-left: 10px;padding: 10.5px 0px;">
                                                                    <!--<a type="button" class="ss_btn" style="cursor:pointer" onclick="pop_111(3)" href="javascript:void(0);">分流检测</a>-->
                                                                    <a type="button" class="ss_btn" target="_blank" href="https://ip.skk.moe/">分流检测</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table style="margin:10px 0px 0px 0px;border-collapse:collapse" width="100%" height="37px">
                                                    <tr>
                                                        <td cellpadding="0" cellspacing="0" style="padding:0" border="1" bordercolor="#222">
                                                            <input id="show_btn7" class="show-btn7" style="cursor:pointer" type="button" value="订阅设置" />
                                                            <input id="show_btn5" class="show-btn5" style="cursor:pointer;display:none;" type="button" value="线路选择" />
                                                            <input id="show_btn0" class="show-btn0" style="cursor:pointer" type="button" value="账号设置" />
                                                            <input id="show_btn1" class="show-btn1" style="cursor:pointer" type="button" value="节点管理" />
                                                            <input id="show_btn2" class="show-btn2" style="display: none; cursor:pointer" type="button" value="故障转移" />
                                                            ...
                                                            <input id="show_btn11" class="show-btn11" style="cursor:pointer;display:none;" type="button" value="查看配置" />
                                            ...
                                            <div id="tablet_5" style="display: none;">
                                                <div id="clash_dashboard"></div>
                                                <!-- <iframe id='clash-dashboard1' style='width:100%;min-height:40rem;border:0;margin-top:1px;' src=''></iframe> -->
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        $('#table_dns').forms([
                                                            { title: '<em>DNS方案设置</em>', thtd:1 , multi: [
                                                                { id:'ss_basic_olddns', name:'ss_basic_olddns', func:'u', hint:'26', type:'radio', suffix: '<a class="hintstyle" href="javascript:void(0);" onclick="openssHint(136)"><font color="#ffcc00">基础</font></a>', value: 0},
                                            ...
                                            <!--fancyss_full_1-->
                                            <div id="tablet_55" style="display: none;">
                                            ...
                                            <div id="tablet_7" style="display: none;">
                                                <table id="table_subscribe" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                                    <script type="text/javascript">
                                                        ...
                                                        $('#table_subscribe').forms([
                                                            // { title: '订阅设置', thead:'1'},
                                                            { title: '<font color="#ffcc00">请填入clash订阅地址</font>', multi: [
                                                                { id:'ss_online_links', type:'password', hint:'116', rows:'12', ph:ph1},
                                                            ...
                                                            // ]}, //fancyss-full
                                                            { title: '订阅操作', multi: [
                                                                { suffix:'<a type="button" class="ss_btn" style="margin-left: 5px; cursor:pointer" onclick="get_online_nodes(3)">保存并订阅</a>'},
                                                                { suffix:'<a type="button" class="ss_btn" style="margin-left: 5px; cursor:pointer" onclick="get_online_nodes(2)">仅保存设置</a>'},
                                                                { prefix: '<span style="margin-left :5px;display:none;">额外设定</span>', style:'display:none;', id: 'ss_adv_sub', type: 'checkbox', value:false, func:'v' },
                                                            ]},
                                                            // { title: '更新订阅时', id:'ss_basic_online_links_goss', type:'select', style:'width:auto', options:[["0", "不使用代理"], ["1", "使用代理"]], value:'0'},
                                                            { title: '订阅计划任务', multi: [
                                                            ...
                                                            { title: '[排除]关键词（含关键词的节点不会添加）', style:'display:none;', rid:'ss_basic_exclude_tr', id:'ss_basic_exclude', type:'text', hint:'110', maxlen:'300', style:'width:95%', ph:ph2},
                                                            { title: '[包括]关键词（含关键词的节点才会添加）', style:'display:none;', rid:'ss_basic_include_tr', id:'ss_basic_include', type:'text', hint:'111', maxlen:'300', style:'width:95%', ph:ph3},
                                                ...
                                                <table id="table_rules" style="margin:8px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
                                                    <script type="text/javascript">
                                                        var option_ruleu = [];
                                                        for (var i = 0; i < 24; i++){
                                                            var _tmp = [];
                                                        ...
                                                        $('#table_rules').forms([
                                                            { title: '规则管理', thead:'1'},
                                                            { title: '规则模式', id:'ss_basic_mode', type:'select', func:'v', hint:'1', options:option_modes, value: "2"},
                                                ...
                                                <!-- prepare to delete <table id="table_link" style="margin:8px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                                    <script type="text/javascript">
                                            ...
                                            <div id="tablet_9" style="display: none;">
                                                <table id="table_addons" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
                                                    <script type="text/javascript">
                                                        ...
                                                        $('#table_addons').forms([
                                                            // { td: '<tr><td class="smth" style="font-weight: bold;" colspan="2">内核更新</td></tr>'},
                                                            // { title: '&nbsp;&nbsp;&nbsp;&nbsp;更新内核', hint:'122', multi: [{ suffix: '<a type="button" class="ss_btn" style="cursor:pointer" onclick="xray_binary_update(2)">更新clash核心程序</a>&nbsp;'},]},
                                                            { td: '<tr><td class="smth" style="font-weight: bold;" colspan="2">规则测试</td></tr>'},
                                                            { title: '&nbsp;&nbsp;&nbsp;&nbsp;输入检测域名', hint:'122', multi: [{ suffix:'<input id="check_rule_value" type="text" class="input_ss_table" style="width:140px;" placeholder="example.com">'},{ suffix:'&nbsp;<input type="button" class="ss_btn" style="cursor:pointer;" onclick="check_rule();" value="检测">'}]},
                                                            // { title: '&nbsp;&nbsp;&nbsp;&nbsp;查看历史状态', rid:'failover_settings_3', multi: [
                                                            //     { suffix:'<a type="button" id="look_logf" class="ss_btn" style="cursor:pointer" onclick="lookup_status_log(1)">国外状态历史</a>&nbsp;' },
                                                            //     { suffix:'<a type="button" id="look_logc" class="ss_btn" style="cursor:pointer" onclick="lookup_status_log(2)">国内状态历史</a>' },
                                                            // ]},
                                                            ...
                                                            // prepare to delete
                                                            // { td: '<tr><td class="smth" style="display: none;  font-weight: bold;" colspan="1">节点列表</td></tr>'},
                                                            // { title: '节点列表最大显示行数', id:'ss_basic_row', type:'select', func:'onchange="save_row();"', style:'display: none; width:auto', options:[]},
                                                            // { title: '开启生成二维码功能', id:'ss_basic_qrcode', func:'v', style: 'display:none;',type:'checkbox', value:true},
                                                            // { title: '开启节点排序功能', id:'ss_basic_dragable', func:'v', style: 'display:none;',type:'checkbox', value:true},
                                                            // { title: '节点管理页面设为默认标签页', id:'ss_basic_tablet', func:'v', style: 'display:none;',type:'checkbox', value:false},
                                                            // { title: '节点管理页面隐藏服务器地址', id:'ss_basic_noserver', func:'v', style: 'display:none;',type:'checkbox', value:false},
                                            ...
                                            <div id="tablet_11" style="display: none;">
                                                <div id="config_content" style="overflow:hidden;">
                                                    <textarea style="width: 99%; padding-right: 0px;" cols="63" rows="36" wrap="on" readonly="readonly" id="config_content1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
                                                </div>
                                            </div>
