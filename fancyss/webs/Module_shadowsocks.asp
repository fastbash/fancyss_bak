                                    ...
                                    <tr>
                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                            ...
                                            <div class="SimpleNote" id="head_illustrate">
                                                <ul id="fixed_msg" style="padding:0;margin:0;line-height:1.8;">
                                                    <li id="msg_0" style="list-style: none;height:23px">
                                                        📌 本插件使用 <a href="https://github.com/MetaCubeX/mihomo"
                                                            target="_blank"><em><u>clash</u></em></a> 实现科学上网。

                                                    </li>
                                                </ul>
                                                <ul id="scroll_msg"
                                                    style="padding:0;margin:0;line-height:1.8;overflow: hidden;">
                                                </ul>
                                            </div>
                                                        ...
                                                        <td colspan="2" >
                                                            <div style="display: flex; border-width: inherit;">
                                                                ...
                                                                <div id="update_button"
                                                                    ...
                                                                    <a id="updateBtn" type="button" class="ss_btn"
                                                                        style="cursor:pointer"
                                                                        onclick="update_ss()">检查并更新</a>
                                                                </div>
                                                                <div id="ss_version_show"
                                                                    style="margin-left: 10px;padding: 5.5px 0px;">
                                                                    <a><i>当前版本：</i></a>
                                                                </div>
                                                                <div
                                                                    style="margin-left: 10px;padding: 5.5px 0px;">
                                                                    <a type="button" class="ss_btn" target="_blank"
                                                                        href="https://github.com/fastbash/fancyss_bak/blob/3.0/Changelog.txt">更新日志</a>
                                                                </div>
                                                                <div
                                                                    style="margin-left: 10px;padding: 5.5px 0px;">
                                                    ...
                                                    <tr id="ss_state">
                                                        ...
                                                        <td>
                                                            <div style="display: flex;">
                                                                ...
                                                                <div
                                                                    style="margin-left: 20px;padding: 10.5px 0px;">
                                                                    <a id="ss_switchnode_btn" type="button" class="ss_btn" style="cursor:pointer;display:none;"
                                                                        target="_blank"
                                                                        href="javascript:void(0);">线路面板</a>
                                                                </div>
                                                                <div
                                                                    style="margin-left: 10px;padding: 10.5px 0px;">
                                                    ...
                                                    <tr>
                                                        <td cellpadding="0" cellspacing="0" style="padding:0" border="1"
                                                            ...
                                                            <input id="show_btn7" class="show-btn7"
                                                                style="cursor:pointer" type="button" value="订阅设置" />
                                                            <input id="show_btn5" class="show-btn5"
                                                                style="cursor:pointer;display:none;" type="button" value="线路选择" />
                                                            <input id="show_btn0" class="show-btn0"
                                                                style="cursor:pointer" type="button" value="账号设置" />
                                                            <input id="show_btn1" class="show-btn1"
                                                                style="cursor:pointer" type="button" value="节点管理" />
                                                            <input id="show_btn2" class="show-btn2"
                                                                style="display: none; cursor:pointer" type="button"
                                                                value="故障转移" />
                                                            ...
                                                            <input id="show_btn6" class="show-btn6"
                                                                style="cursor:pointer" type="button" value="UDP加速" />
                                                            <!--fancyss-full-->
                                            ...
                                            <div id="tablet_7" style="display: none;">
                                                <table id="table_subscribe" width="100%" border="1" align="center"
                                                    cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"
                                                    class="FormTable">
                                                    <script type="text/javascript">
                                                        ...
                                                        $('#table_subscribe').forms([
                                                            ...
                                                            // ]}, //fancyss-full
                                                            {
                                                                title: '订阅操作', multi: [
                                                                    ...
                                                                    // { prefix: '<span style="margin-left :5px">额外设定</span>', id: 'ss_adv_sub', type: 'checkbox', value: false, func: 'v' },
                                                                    { suffix: '<div style="display: none;"><label for="ss_adv_sub" style="margin-left :5px">额外设定</label><input id="ss_adv_sub" type=checkbox class="switch" value=false></div>'},
                                                                ]
                                                            },
                                                            ...
                                                            // {suffix :'<input id="ss_basic_exclude_tr" style="display:none">'},
                                                            // {suffix :'<input id="ss_basic_exclude" style="display:none">'},
                                                            // {suffix :'<input id="ss_basic_include_tr" style="display:none">'},
                                                            // {suffix :'<div style="display: none;"><input id="ss_basic_include" style="display:none"></div>'},
                                                    ...
                                                    <input id="ss_basic_exclude" style="display:none">
                                                    <div style="display: none;"><input id="ss_basic_include" style="display:none"></div>
                                                </table>
                                                <table id="table_rules" style="margin:8px 0px 0px 0px;" width="100%"
                                                    border="1" align="center" cellpadding="4" cellspacing="0"
                                                    bordercolor="#6b8fa3" class="FormTable">
                                                    <script type="text/javascript">
                                                        var option_ruleu = [];
